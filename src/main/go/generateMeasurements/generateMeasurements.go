...
func (ws *WeatherStation) Measurement() float64 {
	stdDev := 10.0 // Define a standard deviation
	m := ws.meanTemperature + rand.NormFloat64()*stdDev
	return float64(int(m*10)) / 10.0 // Round to 1 decimal place
}
